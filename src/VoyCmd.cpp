...
CVoyCmd::CVoyCmd() {
  ...
  QueryInfraRedTime = 0;
  QueryCompassTime = 0;
  QueryMotorParamTime = 0;
  QueryLMotorParamTime = 0;
  QueryRMotorParamTime = 0;
  ...
  m_motorParamThread = nullptr;
  m_motorLParamThread = nullptr;
  m_motorRParamThread = nullptr;
